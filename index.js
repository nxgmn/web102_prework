...
function addGamesToPage(games) {
    ...
    games.forEach(game => {
        ...
        gameCard.innerHTML = '<img src="' + game.img + '" class="game-img" /> <p> ' + game.name + ' </p> <p>' + game.description + '</p>'
...
const total = GAMES_JSON.reduce( (total, n ) => {

    return total + n.backers;
...
const totalAmount = GAMES_JSON.reduce( (total, n) => {

    return total + n.pledged;
...
const unfiltered = GAMES_JSON.filter( (n) => {

    return n.pledged < n.goal;
...
const displayStr = 'A total of $' + totalAmount.toLocaleString() + ' has been raised for ' + numGames + ' games. Currently, ' + unfiltered.length + ' game remains unfunded. We need your help to fund these amazing games!'

// create a new DOM element containing the template string and append it to the description container

const displayElem = document.createElement("p")
displayElem.innerHTML = displayStr

descriptionContainer.appendChild(displayElem)
